...
/** Compressed system identification (CSI) via online iterative soft thresholding, Douglas-Rachford splitting (ADMM), Distributed iterative soft thresholding **/
// Experiment CSI_1: Time varying parameters evoving as STEPWISE CONSTANT functions
...
int main (int argc, char *argv[]) {
	...
	for (t = 1; t < T-M; t += M)   {
		...
		thresh =  LAMBDA*TAU;
        	...
        	/** Compute GLOBAL MINIMUM (e.g., with ADMM) to compare**/
